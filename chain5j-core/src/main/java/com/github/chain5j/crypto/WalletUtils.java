...
import static com.github.chain5j.crypto.Hash.sha256;
import static com.github.chain5j.crypto.Keys.ADDRESS_LENGTH_IN_HEX;
import static com.github.chain5j.crypto.Keys.PRIVATE_KEY_LENGTH_IN_HEX;
...
public class WalletUtils {
    ...
    public static String generateFullNewWalletFile(String cryptoName, String icapPrefix, String password, File destinationDirectory)
            throws NoSuchAlgorithmException, NoSuchProviderException,
            InvalidAlgorithmParameterException, CipherException, IOException {

        return generateNewWalletFile(cryptoName, icapPrefix, password, destinationDirectory, true);
    }

    public static String generateLightNewWalletFile(String cryptoName, String icapPrefix, String password, File destinationDirectory)
            throws NoSuchAlgorithmException, NoSuchProviderException,
            InvalidAlgorithmParameterException, CipherException, IOException {

        return generateNewWalletFile(cryptoName, icapPrefix, password, destinationDirectory, false);
    }

    public static String generateNewWalletFile(String cryptoName, String icapPrefix, String password, File destinationDirectory)
            throws CipherException, InvalidAlgorithmParameterException,
            NoSuchAlgorithmException, NoSuchProviderException, IOException {
        return generateFullNewWalletFile(cryptoName, icapPrefix, password, destinationDirectory);
    }

    public static String generateNewWalletFile(String cryptoName, String icapPrefix,
                                               String password, File destinationDirectory, boolean useFullScrypt)
            throws CipherException, IOException, InvalidAlgorithmParameterException,
            NoSuchAlgorithmException, NoSuchProviderException {

        ECKeyPair ecKeyPair = Keys.createEcKeyPair(cryptoName);
