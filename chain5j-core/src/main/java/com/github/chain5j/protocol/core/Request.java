...
public class Request<S, T extends Response> {
    ...
    private Chain5jService chain5jService;
    ...
    public Request(String method, List<S> params,
                   Chain5jService chain5jService, Class<T> type) {
        this.method = method;
        this.params = params;
    ...
    public T send() throws IOException {
        return chain5jService.send(this, responseType);
    }

    public CompletableFuture<T> sendAsync() {
        return  chain5jService.sendAsync(this, responseType);
    }
