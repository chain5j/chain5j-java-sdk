...
import com.github.chain5j.abi.datatypes.*;
import com.github.chain5j.abi.datatypes.generated.AbiTypes;
import com.github.chain5j.engine.abi.MethodInfo;
import com.github.chain5j.protocol.ObjectMapperFactory;
import com.github.chain5j.protocol.core.methods.response.AbiDefinition;
import com.github.chain5j.abi.FunctionInputDecoder;
import com.github.chain5j.abi.TypeDecoder;
import com.github.chain5j.abi.TypeReference;
import com.github.chain5j.abi.Utils;
import com.github.chain5j.abi.datatypes.*;
import com.github.chain5j.crypto.Hash;
import com.github.chain5j.utils.Numeric;
import com.github.chain5j.utils.StringUtils;
import com.github.chain5j.utils.Strings;
...
public class AbiEngine {
     ...
     *
     * @param abiList
     * @return java.util.List<com.github.chain5j.engine.abi.MethodInfo>
     * @Author: xwc1125
     ...
     * @param input
     * @param abiList
     * @return com.github.chain5j.abi.FunctionInputDecoder.InputData
     * @Author: xwc1125
     ...
     * @param inputs
     * @param outputs
     * @return com.github.chain5j.engine.abi.MethodInfo
     * @Author: xwc1125
     ...
     *
     * @param abi
     * @return java.util.List<com.github.chain5j.protocol.core.methods.response.AbiDefinition>
     * @Author: xwc1125
    ...
    private static Class<? extends Type> getStaticArrayTypeReferenceClass(String type) {
        try {
            return (Class<? extends Type>) Class.forName("com.github.chain5j.abi.datatypes.generated.StaticArray" + type);
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>) Class.forName(
                            "com.github.chain5j.abi.datatypes.generated.StaticArray" + length);
