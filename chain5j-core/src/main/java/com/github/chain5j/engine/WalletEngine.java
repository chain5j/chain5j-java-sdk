...
import com.github.chain5j.bip44.HdKeyNode;
import com.github.chain5j.crypto.*;
...
public class WalletEngine {
     ...
     * @param mnemonics
     * @param password
     * @return com.github.chain5j.crypto.ECKeyPair
     * @Author: xwc1125
     ...
     */
    public static String generateKeystore(String cryptoName, String password, boolean isFullWallet) throws CipherException, IOException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchProviderException {
    ...
    public static String getKeystore(ECKeyPair ecKeyPair, String password, boolean isFullWallet) throws CipherException, IOException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchProviderException {
        WalletFile walletFile;
        if (isFullWallet) {
            walletFile = Wallet.createStandard(password, ecKeyPair);
        } else {
     ...
     */
    public static String generatePrivateKey(String cryptoName)
     ...
     */
    public static WalletFile generateWallet(String cryptoName, String password, boolean isFullWallet)
            throws InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchProviderException,
            CipherException {
        ECKeyPair ecKeyPair = Keys.createEcKeyPair(cryptoName);
        WalletFile walletFile;
