...
public class Keys {
     ...
     */
    static KeyPair createSecp256k1KeyPair(String cryptoName) throws NoSuchProviderException,
            NoSuchAlgorithmException, InvalidAlgorithmParameterException {
        return createSecp256k1KeyPair(cryptoName, SecureRandomUtils.secureRandom());
    }

    static KeyPair createSecp256k1KeyPair(String cryptoName, SecureRandom random) throws NoSuchProviderException,
            NoSuchAlgorithmException, InvalidAlgorithmParameterException {

        KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance("ECDSA", "BC");
        ECGenParameterSpec ecGenParameterSpec = new ECGenParameterSpec(cryptoName);
        if (random != null) {
    ...
    public static ECKeyPair createEcKeyPair(String cryptoName) throws InvalidAlgorithmParameterException,
            NoSuchAlgorithmException, NoSuchProviderException {
        return createEcKeyPair(cryptoName, SecureRandomUtils.secureRandom());
    }

    public static ECKeyPair createEcKeyPair(String cryptoName, SecureRandom random) throws
            InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchProviderException {
        KeyPair keyPair = createSecp256k1KeyPair(cryptoName, random);
